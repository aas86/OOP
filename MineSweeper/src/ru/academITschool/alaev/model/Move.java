...
public class Move implements Minesweeper {
    ...
    @Override
    public PlayingField makeMove(int x, int y, int rows, int columns, int mines, boolean flag, boolean questioned) {
        ...
        if (firstMove) {
            ...
            this.playingField.move(x, y, flag, questioned);
            firstMove = false;
            return playingField;
        } else {
            playingField.move(x, y, flag, questioned);
            return playingField;
        }
    }
}
